clear;clc;
load('Wsy_all_global_solutions.mat')
p=1;  
%% k means clustering
for i=1:100
    p1=transpose(transpose(cell2mat(Wsy(:,1))));

Wall=transpose(cell2mat(transpose((Wsy(:,p))))); 
% [centres, post, errlog] = kmeans_BP(zeros(4,8),Wall);
% idx = spectralcluster(Wall,4)
...
cl4=length(c4);
cl=[cl1 cl2 cl3 cl4];
if cl(1,1:4)==[15 15 15 15] % 15 cluster size
